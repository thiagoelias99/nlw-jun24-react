      ...
      <div className='max-w-[720px] mx-auto'>
        ...
        <div className='w-[720px] mt-5 flex justify-start items-center gap-5 pl-6 pr-4 py-0 bg-zinc-900 h-16 rounded-xl shadow-shape'>
          <div className='flex flex-1 justify-start items-center gap-2'>
            ...
            <input className='bg-transparent placeholder:text-zinc-400' type="text" placeholder="Para onde você vai?" />
          </div>
          <div className='flex justify-end items-center'>
            <div className='w-28 flex justify-end items-center gap-2'>
              <CalendarIcon className='min-h-5 min-w-5 text-zinc-400' />
              <input className='bg-transparent placeholder:text-zinc-400' type="text" placeholder='Quando ?' />
            </div>
            <div className='text-zinc-800 h-full'>|</div>
          </div>
          <button className='bg-lime-300 h-9 text-lime-950 rounded-lg flex items-center justify-center gap2 px-5 py-2'>
            <p>Continuar</p>
